			...
			<View style={{ paddingTop: 100 }}>
				...
				>
					...
					>
						...
						<Text style={{ fontSize: 28, paddingLeft: 6 }}>{parseInt(data.sent).toLocaleString()}</Text>
					</View>
					<View
						style={{
							borderWidth: 1,
					...
					>
						...
						<Text style={{ fontSize: 28, paddingLeft: 6 }}>{parseFloat(data.openRate).toFixed(1)}%</Text>
					</View>
					<View
						style={{
							borderWidth: 1,
					...
					>
						...
						<Text style={{ fontSize: 28, paddingLeft: 6 }}>{parseFloat(data.clickRate).toFixed(1)}%</Text>
					</View>
				</View>
				<View
					style={{
				...
				>
					...
					>
						...
						<Text style={{ fontSize: 28, paddingLeft: 6 }}>{parseFloat(data.averageOpenRate).toFixed(1)}%</Text>
					</View>
					<View
						style={{
							borderWidth: 1,
					...
					>
						...
						<Text style={{ fontSize: 28, paddingLeft: 6 }}>{parseFloat(data.averageClickRate).toFixed(1)}%</Text>
					</View>
				</View>
			</View>
